...
@vehicle_routes.get('/')
async def get_vehicles(database: Session = Depends(get_database)):
    vehicle_service = VehicleService(database)
...
async def get_vehicle_by_complex_apartment(
    ...
    vehicle_service = VehicleService(database)
    return await vehicle_service.get_vehicle_by_complex_apartment(complex, apartment)
...
async def update_by_id(
    ...
    vehicle_service = VehicleService(database)
    return await vehicle_service.update_by_id(id, new_data)